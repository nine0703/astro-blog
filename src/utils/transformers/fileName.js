...
export const transformerFileName = ({
  ...
  pre(node) {
    ...
    node.children.push({
      ...
      properties: {
        class: [
          "absolute py-1 text-base-content text-xs font-medium leading-4",
          hideDot
            ? "px-2"
          ...
          style === "v1"
            ? "left-0 -top-6 rounded-t-md border border-b-0 bg-base-200/50"
            : "left-2 top-(--file-name-offset) border rounded-md bg-base-100",
        ],
      },
      children: [
        {
